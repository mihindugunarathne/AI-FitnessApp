  ...
  return (
    <div className="page-container">
      ...
      <div className="dashboard-header">
         <p className="text-emerald-100 text-5m font-medium">Welcome back</p>
         <h1 className="mt-1 text-2xl font-bold">{`Hi there! 👋 ${user?.username}`}</h1>
          ...
          <div className="mt-4 flex items-center justify-between">
            <div className={`px-3 py-1.5 rounded-lg ${remainingCalories >= 0 ? 
              ...
              <span className="text-sm font-medium">
                {remainingCalories >= 0 ? `${remainingCalories} kcal remaining` 
          ...
          <Card className="bg-linear-to-r from-slate-800 to slate-700">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center">
                <TrendingUpIcon className="w-6 h-6 text-emerald-white" />
              </div>
              <div>
          ...
          <Card>
            ...
            <div className="w-12 h-12 rounded-xl bg-indigo-100 flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Your stats</p>
              </div>
            </div>
