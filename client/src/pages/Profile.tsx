      ...
      <div className="profile-content">
        ...
        <Card>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-xs">Member since {new Date(user?.createdAt || " ")
          ...
          {isEditing ? (
            <div className="space-y-4">
              ...
              <Input label="Weight (kg)" type="number" value={formData.weight} 
               onChange={(v) => setFormData({ ...formData, weight: Number(v) })} min={30} max={300} />
              ...
              {/* Age */}
                <div className="flex items-center gap-4 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg
                  ...
                  <div>
                    ...
                    <p className="font-bold text-slate-800 dark:text-white">{user.age} years</p>
                  </div>
                </div>
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-4 bg-emerald-50 dark:bg-emerald-900/10 rounded-xl">
                <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{stats.totalFoodLogs}</p>
              ...
              <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/10 rounded-xl">
                <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{stats.totalActivityLogs}</p>
          ...
          {/* Logout Button */}
          <Button variant="danger" onClick={logout} className="w-full ring-1 ring-red-300 hover:ring-2">
