...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-[#0a0e14]/95 backdrop-blur-md border-t border-slate-200/80 dark:border-teal-900/30 px-4 pb-safe lg:hidden transition-colors duration-200">
